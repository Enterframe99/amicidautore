                        ...
                        <div class="col-10">
                            <form method="post" action='{{ route('books.update', $book) }}' >
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" name="action" value="save_and_close" class="btn btn-primary">{{ __('SAVE AND CLOSE') }}</button>
                                    <button type="submit" name="action" value="close" class="btn btn-primary">{{ __('CLOSE') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
